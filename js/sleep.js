 ...
 $(document).ready(function() {
   ...
   $("input[type='checkbox']").change(function() {
      //console.log('Toggle: ' + $(this).prop('checked'));
        ...
        if (totalPoint < 30) {
            $('#response').html('no symptoms of Insomnia').css('color', '#ffb3ff');
        };
        if (totalPoint >= 30) {
            $('#response').html('symptoms of Insomnia, a persistant inability to fall asleep or stay awake').css('color', '#ff9933');
        };
